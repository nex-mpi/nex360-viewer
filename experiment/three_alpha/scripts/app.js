class NeXviewerApp{
        ...
        for(var mpiId = 0; mpiId < 30; mpiId++) //this.cfg.c2ws.length
        {
            ...
            for(var i = 0; i < this.cfg.planes.length; i++){
                ...
                this.materials[mpiId].push(new THREE.ShaderMaterial({
                    ...
                    uniforms: {   
                        alpha_ch: {value: i % 4},                   
                        mpi_a: { type: "t", value: this.textures[tid]['a'][Math.floor(i/4)]},
                        mpi_b0: { type: "t", value: this.textures['b0']},
                        mpi_b1: { type: "t", value: this.textures['b1']},
                        mpi_c: { type: "t", value: this.textures[tid]['c'][layer_id]},
                        mpi_k1: { type: "t", value: this.textures[tid]['k'][layer_id][0]},
                        mpi_k2: { type: "t", value: this.textures[tid]['k'][layer_id][1]},
                        mpi_k3: { type: "t", value: this.textures[tid]['k'][layer_id][2]},
                        mpi_k4: { type: "t", value: this.textures[tid]['k'][layer_id][3]},
                        mpi_k5: { type: "t", value: this.textures[tid]['k'][layer_id][4]},
                        mpi_k6: { type: "t", value: this.textures[tid]['k'][layer_id][5]},
                    },
    ...
    loadTexture(callback){
        ...
        var loadMpis = function(mpiId){
            // load only 3 mpi 6,9,14
            var target_mpi = [6,9,14];
            mpiId = target_mpi[mpiId];
...
$(document).ready(function() {
    ...
    if (typeof params.scene === 'undefined'){
        params.scene = '../../data/lego_single_basis_numpy/';
    }
